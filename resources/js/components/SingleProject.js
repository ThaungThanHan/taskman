...
class SingleProject extends Component {
  ...
  componentDidMount () {
    const projectId = this.props.match.params.  // getting id from the params.

    axios.get(`/api/projects/${projectId}`).then(response => {
      this.setState({
        project: response.data, 
        tasks: response.data.tasks  // project nae task nae relationship chate htr lo.tat tat api m lo.
      })
    })
  }
